...
public class DesignOptiuniBibliotecar extends JFrame {
	...
	public DesignOptiuniBibliotecar(int idBibliotecar) {
	...
	schimbaParola = new JButton("SCHIMBA PAROLA CONTULUI TAU");
	...
	ActionListener actSP = new ActionListener() {
		@Override
		public void actionPerformed(ActionEvent e) {
			DesignSchimbaParolaBibliotecar cit = new DesignSchimbaParolaBibliotecar();
			setVisible(false);
			cit.setVisible(true);
		}
	};
